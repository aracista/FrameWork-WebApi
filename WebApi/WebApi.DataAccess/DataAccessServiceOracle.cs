...
{
    public class DataAccessServiceOracle : IDisposable
    {
        ...
        /// </summary>
        public DataAccessServiceOracle()
        {
        ...
        public DataAccessServiceOracle(string databaseName)
        {
        ...
        /// <returns></returns>
        public OracleCommand CreateCommandOra(string qry, CommandType type, params object[] args)
        {
        ...
        public int ExecNonQueryOra(string qry, params object[] args)
        {
            using (OracleCommand cmd = CreateCommandOra(qry, CommandType.Text, args))
            {
        ...
        /// <param name="args">Any number of parameter name/value pairs and/or SQLParameter arguments</param>
        /// <returns>The number of rows affected</returns>
        public int ExecNonQueryProcOra(string proc, params object[] args)
        {
            using (OracleCommand cmd = CreateCommandOra(proc, CommandType.StoredProcedure, args))
            {
                return cmd.ExecuteNonQuery();
            }
        }
        ...
        public object ExecScalarOra(string qry, params object[] args)
        {
            using (OracleCommand cmd = CreateCommandOra(qry, CommandType.Text, args))
            {
        ...
        /// <param name="args">Any number of parameter name/value pairs and/or SQLParameter arguments</param>
        /// <returns>Value of first column and first row of the results</returns>
        public object ExecScalarProcOra(string qry, params object[] args)
        {
            using (OracleCommand cmd = CreateCommandOra(qry, CommandType.StoredProcedure, args))
            {
                return cmd.ExecuteScalar();
            }
        }
        ...
        public OracleDataReader ExecDataReaderOra(string qry, params object[] args)
        {
            using (OracleCommand cmd = CreateCommandOra(qry, CommandType.Text, args))
            {
        ...
        /// <param name="args">Any number of parameter name/value pairs and/or SQLParameter arguments</param>
        /// <returns>Results as a SqlDataReader</returns>
        public OracleDataReader ExecDataReaderProcOra(string qry, params object[] args)
        {
            using (OracleCommand cmd = CreateCommandOra(qry, CommandType.StoredProcedure, args))
            {
                return cmd.ExecuteReader();
        ...
        public DataSet ExecDataSetOra(string qry, params object[] args)
        {
            using (OracleCommand cmd = CreateCommandOra(qry, CommandType.Text, args))
            {
        ...
        /// <param name="args">Any number of parameter name/value pairs and/or SQLParameter arguments</param>
        /// <returns>Results as a DataSet</returns>
        public DataSet ExecDataSetProcOra(string qry, params object[] args)
        {
            using (OracleCommand cmd = CreateCommandOra(qry, CommandType.StoredProcedure, args))
            {
                OracleDataAdapter adapt = new OracleDataAdapter(cmd);
        ...
        public OracleTransaction BeginTransactionOra()
        {
            RollbackOra();
